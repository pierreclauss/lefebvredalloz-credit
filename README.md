...
3. télécharger les packages __tidyverse__, __readxl__, __scales__, __DataExplorer__, __FactoMineR__, __caret__, __rpart__, __copula__ à l'aide de la fonction `install.packages(c("tidyverse", "readxl", "scales", "DataExplorer", "FactoMineR", "caret", "rpart", "copula"))` à écrire dans la console R de RStudio.
